...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=44 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
//VERSION_BEGIN 11.0 cbx_altbarrel_shift 2011:04:27:21:07:08:SJ cbx_altfp_convert 2011:04:27:21:07:08:SJ cbx_altpriority_encoder 2011:04:27:21:07:09:SJ cbx_altsyncram 2011:04:27:21:07:09:SJ cbx_cycloneii 2011:04:27:21:07:09:SJ cbx_lpm_abs 2011:04:27:21:07:09:SJ cbx_lpm_add_sub 2011:04:27:21:07:09:SJ cbx_lpm_compare 2011:04:27:21:07:09:SJ cbx_lpm_decode 2011:04:27:21:07:09:SJ cbx_lpm_divide 2011:04:27:21:07:09:SJ cbx_lpm_mux 2011:04:27:21:07:09:SJ cbx_mgl 2011:04:27:21:08:59:SJ cbx_stratix 2011:04:27:21:07:09:SJ cbx_stratixii 2011:04:27:21:07:09:SJ cbx_stratixiii 2011:04:27:21:07:09:SJ cbx_stratixv 2011:04:27:21:07:09:SJ cbx_util_mgl 2011:04:27:21:07:09:SJ  VERSION_END
...
module  fx_fp_conv_altbarrel_shift_hrf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fx_fp_conv_altbarrel_shift_hrf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fx_fp_conv_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	fx_fp_conv_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	fx_fp_conv_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //fx_fp_conv_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	fx_fp_conv_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fx_fp_conv_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //fx_fp_conv_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	fx_fp_conv_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fx_fp_conv_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //fx_fp_conv_altpriority_encoder_rf8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //fx_fp_conv_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fx_fp_conv_altpriority_encoder_3v7   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	fx_fp_conv_altpriority_encoder_3e8   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //fx_fp_conv_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fx_fp_conv_altpriority_encoder_6v7   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	fx_fp_conv_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //fx_fp_conv_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fx_fp_conv_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	fx_fp_conv_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //fx_fp_conv_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fx_fp_conv_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fx_fp_conv_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //fx_fp_conv_altpriority_encoder_q08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_qf8
	( 
	data,
	q,
	zero) ;
	...
	fx_fp_conv_altpriority_encoder_rf8   altpriority_encoder23
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	fx_fp_conv_altpriority_encoder_rf8   altpriority_encoder24
	( 
	.data(data[31:16]),
...
endmodule //fx_fp_conv_altpriority_encoder_qf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altpriority_encoder_0c6
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	fx_fp_conv_altpriority_encoder_q08   altpriority_encoder7
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder7_q));
	fx_fp_conv_altpriority_encoder_qf8   altpriority_encoder8
	( 
	.data(data[63:32]),
...
endmodule //fx_fp_conv_altpriority_encoder_0c6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 377 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fx_fp_conv_altfp_convert_u5o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fx_fp_conv_altbarrel_shift_hrf   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fx_fp_conv_altpriority_encoder_0c6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
	...
	assign
		...
		const_bias_value_add_width_int_w = 8'b10101001,
...
endmodule //fx_fp_conv_altfp_convert_u5o
//VALID FILE
...
module fx_fp_conv (
	...
	fx_fp_conv_altfp_convert_u5o	fx_fp_conv_altfp_convert_u5o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
