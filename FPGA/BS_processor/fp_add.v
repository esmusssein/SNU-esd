...
module  fp_add_altbarrel_shift_h0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_add_altbarrel_shift_h0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_altbarrel_shift_6hb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fp_add_altbarrel_shift_6hb
...
module  fp_add_altpriority_encoder_6v7
	...
	fp_add_altpriority_encoder_3v7   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q));
	fp_add_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
module  fp_add_altpriority_encoder_6e8
	...
	fp_add_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
module  fp_add_altpriority_encoder_bv7
	...
	fp_add_altpriority_encoder_6v7   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q));
	fp_add_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
module  fp_add_altpriority_encoder_be8
	...
	fp_add_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	fp_add_altpriority_encoder_6e8   altpriority_encoder21
	( 
	.data(data[7:4]),
...
module  fp_add_altpriority_encoder_r08
	...
	fp_add_altpriority_encoder_bv7   altpriority_encoder12
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder12_q));
	fp_add_altpriority_encoder_be8   altpriority_encoder13
	( 
	.data(data[15:8]),
...
module  fp_add_altpriority_encoder_rf8
	...
	fp_add_altpriority_encoder_be8   altpriority_encoder22
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	fp_add_altpriority_encoder_be8   altpriority_encoder23
	( 
	.data(data[15:8]),
...
module  fp_add_altpriority_encoder_qb6
	...
	fp_add_altpriority_encoder_r08   altpriority_encoder10
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder10_q));
	fp_add_altpriority_encoder_rf8   altpriority_encoder11
	( 
	.data(data[31:16]),
...
module  fp_add_altpriority_encoder_qh8
	...
	fp_add_altpriority_encoder_nh8   altpriority_encoder30
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	fp_add_altpriority_encoder_nh8   altpriority_encoder31
	( 
	.data(data[3:2]),
...
module  fp_add_altpriority_encoder_vh8
	...
	fp_add_altpriority_encoder_qh8   altpriority_encoder29
	( 
	.data(data[7:4]),
...
module  fp_add_altpriority_encoder_fj8
	...
	fp_add_altpriority_encoder_vh8   altpriority_encoder27
	( 
	.data(data[15:8]),
...
module  fp_add_altpriority_encoder_q28
	...
	fp_add_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	fp_add_altpriority_encoder_n28   altpriority_encoder37
	( 
	.data(data[3:2]),
...
module  fp_add_altpriority_encoder_v28
	...
	fp_add_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	fp_add_altpriority_encoder_q28   altpriority_encoder35
	( 
	.data(data[7:4]),
...
module  fp_add_altpriority_encoder_f48
	...
	fp_add_altpriority_encoder_vh8   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	fp_add_altpriority_encoder_v28   altpriority_encoder33
	( 
	.data(data[15:8]),
...
module  fp_add_altpriority_encoder_e48
	...
	fp_add_altpriority_encoder_fj8   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	fp_add_altpriority_encoder_f48   altpriority_encoder25
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_altfp_add_sub_9vj
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fp_add_altbarrel_shift_h0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_altbarrel_shift_6hb   rbarrel_shift
	( 
...
endmodule //fp_add_altfp_add_sub_9vj
//VALID FILE
...
module fp_add (
	...
	fp_add_altfp_add_sub_9vj	fp_add_altfp_add_sub_9vj_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
