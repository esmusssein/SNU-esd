...
module  altfp_add_altbarrel_shift_h0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //altfp_add_altbarrel_shift_h0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altbarrel_shift_n3g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //altfp_add_altbarrel_shift_n3g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_uv8
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //altfp_add_altpriority_encoder_uv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_ue9
	( 
	data,
	q,
	zero) ;
...
endmodule //altfp_add_altpriority_encoder_ue9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_ou8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_altpriority_encoder_uv8   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	altfp_add_altpriority_encoder_ue9   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //altfp_add_altpriority_encoder_ou8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_ii9
	( 
	data,
	q,
	zero) ;
...
endmodule //altfp_add_altpriority_encoder_ii9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_i39
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //altfp_add_altpriority_encoder_i39

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_cna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_altpriority_encoder_ii9   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	altfp_add_altpriority_encoder_i39   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //altfp_add_altpriority_encoder_cna

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 716 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altfp_add_sub_12j
	( 
	clock,
	dataa,
	datab,
	...
	altfp_add_altbarrel_shift_h0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_altbarrel_shift_n3g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_altpriority_encoder_ou8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_altpriority_encoder_cna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //altfp_add_altfp_add_sub_12j
//VALID FILE
...
module altfp_add (
	...
	altfp_add_altfp_add_sub_12j	altfp_add_altfp_add_sub_12j_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
