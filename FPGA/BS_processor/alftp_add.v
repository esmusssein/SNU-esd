...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" DIRECTION="ADD" OPTIMIZE="AREA" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
//VERSION_BEGIN 11.0 cbx_altbarrel_shift 2011:04:27:21:07:08:SJ cbx_altfp_add_sub 2011:04:27:21:07:08:SJ cbx_altpriority_encoder 2011:04:27:21:07:09:SJ cbx_cycloneii 2011:04:27:21:07:09:SJ cbx_lpm_add_sub 2011:04:27:21:07:09:SJ cbx_lpm_compare 2011:04:27:21:07:09:SJ cbx_mgl 2011:04:27:21:08:59:SJ cbx_stratix 2011:04:27:21:07:09:SJ cbx_stratixii 2011:04:27:21:07:09:SJ  VERSION_END
...
//VERSION_BEGIN 11.0 cbx_altbarrel_shift 2011:04:27:21:07:08:SJ cbx_mgl 2011:04:27:21:08:59:SJ  VERSION_END

//synthesis_resources = reg 27 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altbarrel_shift_h0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //alftp_add_altbarrel_shift_h0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altbarrel_shift_6hb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //alftp_add_altbarrel_shift_6hb


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" WIDTH=32 WIDTHAD=5 data q
//VERSION_BEGIN 11.0 cbx_altpriority_encoder 2011:04:27:21:07:09:SJ cbx_mgl 2011:04:27:21:08:59:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //alftp_add_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //alftp_add_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	alftp_add_altpriority_encoder_3v7   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q));
	alftp_add_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
endmodule //alftp_add_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	alftp_add_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	alftp_add_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
endmodule //alftp_add_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	alftp_add_altpriority_encoder_6v7   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q));
	alftp_add_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //alftp_add_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	alftp_add_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	alftp_add_altpriority_encoder_6e8   altpriority_encoder21
	( 
	.data(data[7:4]),
...
endmodule //alftp_add_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	alftp_add_altpriority_encoder_bv7   altpriority_encoder12
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder12_q));
	alftp_add_altpriority_encoder_be8   altpriority_encoder13
	( 
	.data(data[15:8]),
...
endmodule //alftp_add_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	alftp_add_altpriority_encoder_be8   altpriority_encoder22
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	alftp_add_altpriority_encoder_be8   altpriority_encoder23
	( 
	.data(data[15:8]),
...
endmodule //alftp_add_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	alftp_add_altpriority_encoder_r08   altpriority_encoder10
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder10_q));
	alftp_add_altpriority_encoder_rf8   altpriority_encoder11
	( 
	.data(data[31:16]),
...
endmodule //alftp_add_altpriority_encoder_qb6
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //alftp_add_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	alftp_add_altpriority_encoder_nh8   altpriority_encoder30
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	alftp_add_altpriority_encoder_nh8   altpriority_encoder31
	( 
	.data(data[3:2]),
...
endmodule //alftp_add_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	alftp_add_altpriority_encoder_qh8   altpriority_encoder28
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder28_q),
	.zero(wire_altpriority_encoder28_zero));
	alftp_add_altpriority_encoder_qh8   altpriority_encoder29
	( 
	.data(data[7:4]),
...
endmodule //alftp_add_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
	...
	alftp_add_altpriority_encoder_vh8   altpriority_encoder26
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder26_q),
	.zero(wire_altpriority_encoder26_zero));
	alftp_add_altpriority_encoder_vh8   altpriority_encoder27
	( 
	.data(data[15:8]),
...
endmodule //alftp_add_altpriority_encoder_fj8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //alftp_add_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	alftp_add_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	alftp_add_altpriority_encoder_n28   altpriority_encoder37
	( 
	.data(data[3:2]),
...
endmodule //alftp_add_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	alftp_add_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	alftp_add_altpriority_encoder_q28   altpriority_encoder35
	( 
	.data(data[7:4]),
...
endmodule //alftp_add_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	alftp_add_altpriority_encoder_vh8   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	alftp_add_altpriority_encoder_v28   altpriority_encoder33
	( 
	.data(data[15:8]),
...
endmodule //alftp_add_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altpriority_encoder_e48
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	alftp_add_altpriority_encoder_fj8   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	alftp_add_altpriority_encoder_f48   altpriority_encoder25
	( 
	.data(data[31:16]),
...
endmodule //alftp_add_altpriority_encoder_e48

//synthesis_resources = lpm_add_sub 9 lpm_compare 1 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alftp_add_altfp_add_sub_9vj
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	alftp_add_altbarrel_shift_h0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	alftp_add_altbarrel_shift_6hb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	alftp_add_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	alftp_add_altpriority_encoder_e48   trailing_zeros_cnt
	( 
...
endmodule //alftp_add_altfp_add_sub_9vj
//VALID FILE
...
module alftp_add (
	...
	alftp_add_altfp_add_sub_9vj	alftp_add_altfp_add_sub_9vj_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
