...
module ram (
	...
	wire [16:0] ram_address = sub_wire2[16:0];
	wire  ram_wren = sub_wire3;

	ram_meminit_eak	ram_meminit_eak_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
